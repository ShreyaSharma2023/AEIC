...
class BasePerformanceModel[RulesT](CIBaseModel, ABC):
    ...
    def minimum_tas(self) -> float:
        ...
        Trajectory builders use this only as a placeholder for a flight's
        first point, replaced by a feasible value on the first call to the
        performance model. To be implemented by subclasses."""
        ...
