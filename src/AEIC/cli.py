...
from AEIC.commands.make_piano_performance_model import make_piano_performance_model
...
cli.add_command(make_piano_performance_model, name='make-piano-performance-model')
